  ...
  return (
    <div className="flex items-center sm:flex-col mb-4 sm:mb-10">
      ...
      <div className="flex flex-col sm:items-center">
        <h1 className="sm:mb-3 text-3xl sm:text-5xl font-extrabold dark:text-white">
          <span>人民大會堂</span>
          <span>模擬器</span>
        </h1>
        <span className="text-gray-700 dark:text-gray-300 text:lg sm:text-xl italic">沒有，通過 👏</span>
      </div>
    </div>
  )
}
